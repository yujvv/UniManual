# Layer	Number Mot ID	Name
# 1	2,3,4	idle
# 2	6	Formally greeting
# 2	7	Jump greeting(Genki)
# 2	8	Scrub eye greeting(tired)
# 3	27	Both hand(palm) guide to right
# 3	30	Both hand(palm) guide to left
# 3	33	Both hand(palm) guide to front
# 4	37	Right hand point up to guide with facing
# 4	39	Right hand point right to guide with facing
# 4	40	Right hand point left to guide with facing
# 5	65	leave it to me
# 5	74,80	Wave arm to say goodbye
# 7	87,88,89	Appreciate
# 8	92	Clap hand to praise
# 8	93,95	Tap head to comfort
# 9	96,97,98	Laugh
# 10	108	Hand hold waist to show furious
# 10	110,111	Confuse
# 11	112	Count down, 3,2,1
# 11	113,115	Count down, 5,4,3,2,1
# 12	116	Show finger Number 1
# 12	117	Show finger Number 2
# 12	118	Show finger Number 3
# 13	131	pick up phone，start order delivery
# 13	132	hang up phone，end order delivery
# 13	133	talking with phone，ordering delivery
# 14	150	wave hand palm to negate
# 14	153	cross arms to refuse
# 14	156	shake head and negate
# 15	157	hold umbrella，rain
# 15	160	hand against sun，hot
# 15	161	cough，cold


actions_semantics_old = {
    2: [
        "有什么需要随时告诉我。",
        "准备好了就请告诉我。",
        "有问题随时可以问。",
